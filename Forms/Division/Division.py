...
# Form implementation generated from reading ui file '.\Division.ui'
#
...
class Ui_Divisiones(object):
    def setupUi(self, Dialog, selectRegister = None, ref_tx_id_division = None):
        ...
        self.radioButton_materia = QtWidgets.QRadioButton(Dialog)
        self.radioButton_materia.setGeometry(QtCore.QRect(440, 10, 82, 21))
        font = QtGui.QFont()
...
"")
        ...
        self.radioButton_division.setGeometry(QtCore.QRect(340, 10, 82, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(11)
        ...
        self.radioButton_codigo.setGeometry(QtCore.QRect(250, 10, 71, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(11)
...
"color: rgb(255, 255, 255);")
        ...
        Dialog.setTabOrder(self.radioButton_codigo, self.radioButton_division)
        Dialog.setTabOrder(self.radioButton_division, self.radioButton_materia)
        Dialog.setTabOrder(self.radioButton_materia, self.tableWidget)

        from Forms.Division.ControllerDivision import ControllerDivision
        controller = ControllerDivision(self, Dialog, selectRegister, ref_tx_id_division)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Divisiones"))
        self.radioButton_materia.setText(_translate("Dialog", "Materia"))
